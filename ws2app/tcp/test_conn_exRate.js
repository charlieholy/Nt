...
bufh.write(sss_head)
bufh.writeUIntBE(s_len,  12, 1);
bufh.write(s_con,13,s_len);

var crc_buf = bufh.slice(0,13+s_len);
var crcres = crc.crc32(crc_buf)
console.log(crcres.toString());

bufh.writeUIntBE(crcres,13+s_len, 4);
console.log(bufh);

var send_buf = bufh.slice(0,13+s_len+4);
